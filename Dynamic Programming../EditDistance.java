...
public class EditDistance {
    ...
    public int minDistance(String A, String B) {
        ...
        // cache[i][j] stores minimum edit distance between string A (starting from i) and string B (starting from j)
    ...
    private int minDistance(String A, String B, int stIndexA, int stIndexB) {
        ...
        // characters are different, so delete, replace and insert char. from B and compute distances
        cache[stIndexA][stIndexB] = min(1 + minDistance(A, B, stIndexA+1, stIndexB+1),
                1 + minDistance(A, B, stIndexA, stIndexB+1),
                1 + minDistance(A, B, stIndexA+1, stIndexB));
